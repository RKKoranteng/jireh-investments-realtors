  ...
  <div class="u-clearfix u-sheet u-sheet-1" style="min-height: auto;">
	<div id="comments" class="comments-area">
		<?php if ( have_comments() ) : ?>
			<h3 class="comments-title">
				...
				if ( 1 === $comments_number ) {
					...
					printf( _x( 'One thought on &ldquo;%s&rdquo;', 'comments title', 'jirehrealtors' ), get_the_title() );
				} else {
					printf(
			...
			<ol class="comment-list">
				...
				$comments_html = str_replace(
					...
					wp_list_comments(array(
						...
						'short_ping'  => true,
						'avatar_size' => 42,
						'reply_text'  => '' . __('Reply', 'jirehrealtors') . '',
						'echo'        => false,
					))
				);
		...
		if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) :
			?>
			<p class="no-comments u-gallery-text"><?php _e( 'Comments are closed.', 'jirehrealtors' ); ?></p>
		<?php endif; ?>
