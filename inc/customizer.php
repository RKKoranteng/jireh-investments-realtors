...
function theme_customize_register($wp_customize) {
    ...
    $wp_customize->add_control('color_scheme', array(
        'label' => __('Color Scheme', 'jirehrealtors'),
        'section' => 'colors',
        'type' => 'select',
        'choices' => array(),
        'priority' => 1,
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_$i", array(
            'label' => sprintf(__('Color %s', 'jirehrealtors'), $i),
            'section' => 'colors',
        )));
    }
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_white_contrast", array(
        'label' => __('Text Dark', 'jirehrealtors'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_shading_contrast", array(
        'label' => __('Text Light', 'jirehrealtors'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_background", array(
        'label' => __('Background', 'jirehrealtors'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control('font_scheme', array(
        'label' => __('Font Scheme', 'jirehrealtors'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_heading', array(
        'label' => __('Heading Font', 'jirehrealtors'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_text', array(
        'label' => __('Text Font', 'jirehrealtors'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_section('typography', array(
        'capability' => 'edit_theme_options',
        'title' => __('Typography', 'jirehrealtors'),
        'priority' => 40,
    ));
    ...
    $wp_customize->add_control('typography_scheme', array(
        'label' => __('Typography Scheme', 'jirehrealtors'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'typography_base_size', array(
        'type' => 'number',
        'label' => __('Base Size', 'jirehrealtors'),
        'section' => 'typography',
        'input_attrs' => array(
            'min'   => 13,
            'max'   => 24,
    ...
    $wp_customize->add_control('typography_heading_weight', array(
        'label' => __('Heading Weight', 'jirehrealtors'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(
            '100' => __('100 Thin', 'jirehrealtors'),
            '300' => __('300 Light', 'jirehrealtors'),
            '400' => __('400 Regular', 'jirehrealtors'),
            '500' => __('500 Medium', 'jirehrealtors'),
            '700' => __('700 Bold', 'jirehrealtors'),
            '900' => __('900 Black', 'jirehrealtors'),
        ),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_width', array(
        'type' => 'number',
        'label' => __('Logo max width (px)', 'jirehrealtors'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_height', array(
        'type' => 'number',
        'label' => __('Logo max height (px)', 'jirehrealtors'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_link', array(
        'type' => 'url',
        'label' => __('Logo link href', 'jirehrealtors'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'custom_favicon', array(
        'label' => __('Favicon', 'jirehrealtors'),
        'section' => 'title_tagline',
        'priority' => 8,
        'height' => '64',
        'width' => '64',
        'button_labels' => array(
            'select' => __('Select favicon', 'jirehrealtors'),
            'change' => __('Change favicon', 'jirehrealtors'),
            'remove' => __('Remove', 'jirehrealtors'),
            'default' => __('Default', 'jirehrealtors'),
            'placeholder' => __('No favicon selected', 'jirehrealtors'),
            'frame_title' => __('Select favicon', 'jirehrealtors'),
            'frame_button' => __('Choose favicon', 'jirehrealtors'),
        ),
    )));
    ...
    $wp_customize->add_section('menu_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Theme options', 'jirehrealtors'),
        'panel' => 'nav_menus',
    ));
    ...
    $wp_customize->add_control('menu_trim_title', array(
        ...
        'label' => __('Trim long menu items', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('menu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each item to [N] characters', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('submenu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each subitem to [N] characters', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('menu_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Apply menu item tag filter', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('menu_allowed_tags', array(
        'type' => 'text',
        'section' => 'menu_options',
        'label' => __('Allowed menu item tags', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('use_default_menu', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Use not stylized menu', 'jirehrealtors'),
        'description' => __('Used standart wp_nav_menu when option is enabled (need for some third-party plugins).', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_section('excerpt_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Excerpt', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('excerpt_auto', array(
        ...
        'label' => __('Use auto excerpts', 'jirehrealtors'),
        'description' => __('Generate post excerpts automatically (When neither more-tag nor post excerpt is used)', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('excerpt_words', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt length (words)', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('excerpt_min_remainder', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt balance (words)', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('excerpt_strip_shortcodes', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Remove shortcodes from excerpt', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('excerpt_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Apply excerpt tag filter', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('excerpt_allowed_tags', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('Allowed excerpt tags', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('show_morelink', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Show More Link', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('morelink_template', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('More Link Template', 'jirehrealtors'),
        'description' => sprintf(__('ShortTags: %s', 'jirehrealtors'), '[url], [text]'),
    ));
    ...
    $wp_customize->add_control('seo_og', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include Open Graph meta tags', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('seo_ld', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include schema.org JSON-LD syntax markup', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_section('other_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Other settings', 'jirehrealtors'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('include_jquery', array(
        ...
        'label' => __('Use jQuery from theme', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_section('sidebar_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Sidebars', 'jirehrealtors'),
        'priority' => 100,
    ));

    $layouts_choices = array(
        '' => __('Default', 'jirehrealtors'),
        'left-sidebar' => __('Left', 'jirehrealtors'),
        'right-sidebar' => __('Right', 'jirehrealtors'),
        'none' => __('None', 'jirehrealtors'),
    );
    ...
    $wp_customize->add_control('sidebars_layout_blog', array(
        ...
        'label' => __('Blog Template', 'jirehrealtors'),
        'description' => __('Templates for displaying blogs, archives, search results', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_post', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Post Template', 'jirehrealtors'),
        'description' => __('Templates for displaying single posts', 'jirehrealtors'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_default', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Default Template', 'jirehrealtors'),
        'description' => __('Templates for displaying single pages and everything else', 'jirehrealtors'),
    ));
}
add_action('customize_register', 'theme_customize_register', 11);

function theme_print_sidebars_blog_caption() {
    printf('<h3>%s</h3>', __('Display sidebars on:', 'jirehrealtors'));
}
