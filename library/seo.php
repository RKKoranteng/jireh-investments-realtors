...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://facebook.com/Carol.Real.Estate.Agent","https://linkedin.com/in/carol-walton-aa3735117"));
    ...
    $logo = theme_get_logo(array('default_src' => "/images/Jireh-Investments-Realtors1.png", 'default_url' => ''));
    if (!empty($logo['src'])) {
