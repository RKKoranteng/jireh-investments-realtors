...
function theme_register_required_plugins() {
	...
	$plugin_source = get_template_directory() . '/plugins/jirehrealtor.zip';
	...
	$plugins = array(
      		array(
      			'name'               => 'JirehRealtor',     // The plugin name.
      			'slug'               => 'jirehrealtor',     // The plugin slug (typically the folder name).
	...
	$config = array(
		'id'           => 'tgmpa-jirehrealtor',        // Unique ID for hashing notices for multiple instances of TGMPA.
