<?php $skip_min_height = false; ?><?php global $wp_query; if ($wp_query->max_num_pages > 1): ?><section class="u-clearfix u-section-5" id="sec-01c8">
    ...
    <ul class="responsive-style1 u-pagination u-unstyled u-pagination-1"><?php
            ...
            if ($wp_query->max_num_pages > 1) {
                $pagination_links = paginate_links(array(
                    ...
                    'type'			=> 'array',
                    'prev_text'     => __('&#x3008;', 'jirehrealtors'),
                    'next_text'     => __('&#x3009;', 'jirehrealtors'),
                    'end_size'      => 1,
                    'mid_size'      => 1,
                ));
